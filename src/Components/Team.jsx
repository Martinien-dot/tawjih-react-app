...
// import ads from "../assets/images/svg/ads.png";
    ...
    <div className=" section-padding">
      <div className="container">
        <div className="text-center">
          <div className="mini-title">Lisez les avis de ceux qui ont déjà été accompagnés</div>
          <div className="column-title ">
          Ils partagent leur expérience avec Tawjih ba3d <span className="shape-bg">  Lbac </span>
          </div>
        </div>
