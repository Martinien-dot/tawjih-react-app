...
import { getOffre } from "../mes composants/Slices/offreSlice";

const OffreInformation = () => {
  let {idOffre} = useParams()
  const { loading,offreInfo,error } = useSelector(st => st.offre);
  const dispatch = useDispatch()


  useEffect(()=>{
      dispatch(getOffre(idOffre));
...
export default OffreInformation;
