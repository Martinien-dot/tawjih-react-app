    ...
    <div className=" section-padding">
      <div className="container">
        <div className="text-center">
          <div className="mini-title">L’orientation, c’est le début de votre voyage. Lisez, explorez, choisissez !</div>
          <div className="column-title ">
            Meilleurs <span className="shape-bg">Articles</span> utiles pour vous guider dans votre choix d'études après le bac
          </div>
        </div>
